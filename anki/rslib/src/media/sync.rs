...
pub use slog::{debug, Logger,self,o};
use time::Duration;
...
pub struct UploadEntry<'a> {
   pub fname: &'a str,
    pub in_zip_name: Option<String>,
}

#[derive(Deserialize, Debug,Serialize)]
pub struct UploadResult {
   pub data: Option<UploadReply>,
pub    err: String,
}
...
pub fn extract_into_media_folder(
    media_folder: &Path,
    zip: Bytes,
    log: &Logger,
